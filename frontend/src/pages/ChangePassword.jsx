    ...
    <div className="space-y-1.5">
      ...
      <div className="group relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-slate-200/80 bg-slate-50/50 py-3.5 pl-11 pr-12 text-sm font-medium text-slate-900 outline-none transition-all hover:bg-slate-50 focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-500/10"
        />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/60 p-5">
              ...
              <ul className="mt-3 space-y-2.5 text-xs font-semibold">
                <Requirement valid={rules.length}>
                  At least 8 characters
                </Requirement>

                <Requirement valid={rules.match}>
                  Passwords match
                </Requirement>

                <Requirement valid={rules.different}>
                  Different from current password
                </Requirement>

                <Requirement valid={/[A-Z]/.test(form.newPassword)}>
                  At least one uppercase letter
                </Requirement>

                <Requirement valid={/[0-9]/.test(form.newPassword)}>
                  At least one number
                </Requirement>
              </ul>
            </div>
