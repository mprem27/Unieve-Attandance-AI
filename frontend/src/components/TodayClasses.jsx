...
export default function Dashboard() {
  ...
  const premiumCard =
    "bg-white/70 backdrop-blur-md rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 overflow-hidden transition-all duration-300";

  const arrowBtn =
    "w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-gray-200/50 bg-white/50 flex items-center justify-center text-gray-500 backdrop-blur-sm";
    ...
    <div className="relative min-h-screen bg-transparent text-gray-900 font-sans pb-28 md:pb-12">
      ...
      <header className="md:hidden fixed top-0 left-0 w-full z-40 flex justify-between items-center px-6 h-20 bg-white/70 backdrop-blur-xl border-b border-white/50">
        ...
        <button
          ...
          className={`flex items-center justify-center w-10 h-10 rounded-full bg-white/80 border border-white/50 shadow-sm text-gray-600 active:scale-95 transition-all ${
            isRefreshing
              ? "animate-spin text-[#185e3a]"
              : ""
          }`}
        >
      ...
      <main className="relative z-10 mx-auto max-w-[1440px] flex flex-col h-full p-4 pt-24 md:pt-10 md:px-8 gap-6">
        ...
        <div className="bg-gradient-to-r from-[#185e3a]/85 to-[#0a311b]/85 backdrop-blur-md border border-white/10 rounded-[24px] p-6 sm:p-8 text-white shadow-lg relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 min-h-[130px] mb-2">
          ...
          <div className="relative z-10 flex-1 min-w-0">
            ...
            <h2
              className="text-2xl sm:text-3xl font-extrabold tracking-tight mb-1 text-white drop-shadow-md break-words whitespace-normal"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="bg-[#185e3a]/85 backdrop-blur-md border border-white/20 rounded-[24px] p-5 sm:p-6 shadow-md flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
              ...
              <h3 className="text-xs sm:text-sm font-medium text-white/90 drop-shadow-sm">
                Overall %
              </h3>
              ...
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center text-white shadow-inner">
                ...
                <span className="material-symbols-outlined text-[16px] sm:text-[18px] transform -rotate-45">
                  arrow_forward
                </span>
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-white mb-3 drop-shadow-md">
                {overallPercentage}
              </h2>
          ...
          <div
            className={`${premiumCard} p-5 sm:p-6 flex flex-col justify-between`}
          >

            <div className="flex justify-between items-start mb-4">

              <h3 className="text-xs sm:text-sm font-medium text-gray-800 drop-shadow-sm">
                Classes Attended
              </h3>
            ...
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-3 drop-shadow-sm">
                {totalPresent}
              </h2>
        ...
        <div className={`${premiumCard} p-5 sm:p-8`}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 border-b border-white/50 pb-4">
            ...
            <div className="flex items-center gap-2 bg-emerald-50/80 backdrop-blur-sm text-emerald-700 px-3 py-1.5 rounded-full border border-emerald-200/50 shadow-sm w-fit">
          ...
          {safeTodayAttendance.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center text-center py-8 rounded-2xl bg-white/40 border border-white/50">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Today's classes will appear here after synchronization.
              </p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-[#ecfdf5] border border-emerald-200 text-[#185e3a]">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6">
          ...
          <div className="flex flex-col gap-6 lg:col-span-4 order-1 lg:order-2">
            ...
            <div
              className={`${premiumCard} p-6 sm:p-8 flex flex-col justify-between order-1`}
            >
              ...
              <div>
                ...
                <h4 className="text-2xl font-bold text-[#185e3a] drop-shadow-sm">
                  75% Minimum
                </h4>
              ...
              <Link
                to="/attendance"
                className="mt-6 w-full py-3 bg-[#185e3a]/90 backdrop-blur-md border border-white/20 text-white text-sm font-bold rounded-full text-center hover:bg-[#11462a] transition-colors flex items-center justify-center gap-2 shadow-sm"
              >
            ...
            <div
              className={`${premiumCard} flex flex-col p-6 sm:p-8 bg-white/70 order-2`}
            >

              <h3 className="text-lg font-bold text-gray-900 mb-6 text-center sm:text-left drop-shadow-sm">
                Overall Attendance
              </h3>
                ...
                <div className="mt-10 sm:mt-12 flex flex-col items-center w-full gap-3 border-t border-white/50 pt-5">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 w-full">
                    ...
                    <div className="flex items-center gap-2 bg-[#ecfdf5]/80 backdrop-blur-sm border border-[#d1fae5]/50 px-3 py-1.5 rounded-full shadow-sm">
                      ...
                      <span className="text-[10px] sm:text-xs font-bold text-emerald-800 uppercase tracking-widest">
                    ...
                    <div className="flex items-center gap-2 bg-[#fef2f2]/80 backdrop-blur-sm border border-[#ffe4e6]/50 px-3 py-1.5 rounded-full shadow-sm">
                      ...
                      <span className="text-[10px] sm:text-xs font-bold text-rose-800 uppercase tracking-widest">
                        Absent: {totalAbsent}
                      </span>
          ...
          <div className="flex flex-col gap-6 lg:col-span-8 order-2 lg:order-1">
            ...
            <div
              className={`${premiumCard} flex flex-col p-5 sm:p-8 order-2 lg:order-1`}
            >
              ...
              <div className="flex-1 bg-white/50 backdrop-blur-md rounded-2xl p-4 sm:p-6 flex flex-col justify-center min-h-[300px] sm:min-h-[350px] border border-white/50 shadow-inner">
                ...
                {safeSummary.length === 0 ? (
                  ...
                  <div className="flex flex-col w-full h-full mt-auto">
                      ...
                      {chartDisplayData.map(
                        (subject, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="flex flex-col items-center gap-2 sm:gap-3 flex-1 min-w-[30px] sm:min-w-[40px] max-w-[60px] sm:max-w-[70px] h-full z-10"
                            >

                              <div
                                className="relative w-full h-full rounded-full flex items-end overflow-visible bg-white/40 backdrop-blur-sm border border-white/50 shadow-inner"
                                style={{
                                  backgroundImage:
                              ...
                              >
                                ...
                                <div className="w-full flex items-end justify-center h-full relative">
                                  ...
                                  {percentage > 0 && (
                                    <div className="absolute -top-7 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md border border-white/50 shadow-md text-[9px] sm:text-[11px] font-extrabold text-[#185e3a] px-2 py-0.5 rounded-full z-20">
                                      {percentage}%
                                    </div>
                                  )}

                                  <div
                                    className={`w-full rounded-full transition-all duration-1000 ease-out shadow-md ${
                                      percentage > 0
                                        ? barColor
                                        : "bg-transparent"
                                    }`}
                              ...
                              <span className="text-[10px] sm:text-[12px] font-bold text-gray-700 uppercase tracking-widest truncate w-full text-center absolute bottom-0 drop-shadow-sm">
                                {displayLabel}
                              </span>
                    ...
                    <div className="mt-2 sm:mt-4 pt-4 border-t border-white/50 flex flex-wrap justify-center sm:justify-start gap-x-4 gap-y-2.5 w-full">
                      ...
                      {chartDisplayData.map(
                        (subject, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="flex items-center gap-1.5 min-w-[120px] max-w-[180px]"
                            >

                              <div
                                className={`w-2.5 h-2.5 rounded-full shrink-0 shadow-sm ${getBarColor(
                                  index
                                )}`}
                              ></div>

                              <span className="text-[10px] sm:text-[11px] font-bold text-gray-900 shrink-0 uppercase tracking-widest drop-shadow-sm">
                                {displayLabel}
                              </span>

                              <span
                                className="text-[9px] sm:text-[10px] font-medium text-gray-700 truncate drop-shadow-sm"
                                title={
                                  subject?.subjectName
                                }
                              >
        ...
        <div
          className={`mb-10 ${premiumCard} flex flex-col p-5 sm:p-8`}
        >
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <Link
              to="/attendance"
              className="px-4 py-2 border border-white/50 bg-white/60 backdrop-blur-md rounded-xl text-xs sm:text-sm font-bold flex items-center gap-2 hover:bg-white/80 text-gray-700 transition-colors shadow-sm"
            >
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            ...
            {safeSummary.length === 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <span className="material-symbols-outlined text-4xl text-gray-400 mb-3 drop-shadow-sm">
                  library_books
                </span>
                  ...
                  (subject, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex flex-col gap-4 group border border-white/50 bg-white/50 backdrop-blur-md p-5 sm:p-6 rounded-2xl hover:bg-white/70 hover:shadow-lg transition-all shadow-sm"
                      >
                        ...
                        <div className="flex items-start justify-between gap-4 w-full">
                          ...
                          <div className="shrink-0 pt-1">
                            ...
                            <span
                              className={`inline-block px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest shadow-sm border ${
                                isLow
                                  ? "bg-red-100/80 backdrop-blur-sm text-red-700 border-red-200/50"
                                  : "bg-emerald-100/80 backdrop-blur-sm text-[#185e3a] border-emerald-200/50"
                              }`}
                            >
                              {isLow
                                ? "WARNING"
                        ...
                        <div className="flex flex-col gap-2 mt-2">
                          ...
                          <div className="flex justify-between items-end px-1">
                            ...
                            <span className="text-[11px] sm:text-[12px] font-bold text-gray-600">
                              ...
                              <span className="text-gray-900 ml-1 drop-shadow-sm">
                                {subject?.present} /{" "}
                                {total} Classes
                              </span>
                            ...
                            <span
                              className={`text-[13px] sm:text-[14px] font-black drop-shadow-sm ${
                                isLow
                                  ? "text-red-600"
                                  : "text-[#185e3a]"
                              }`}
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 py-3 bg-white/80 backdrop-blur-xl border-t border-white/50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] pb-safe">
        ...
        <Link
          to="/"
          className="flex flex-col items-center justify-center p-2 rounded-xl min-w-[64px] text-[#185e3a] bg-emerald-50/80 border border-emerald-100/50 transition-all shadow-sm"
        >
        ...
        <Link
          to="/attendance"
          className="flex flex-col items-center justify-center p-2 rounded-xl min-w-[64px] text-gray-500 hover:text-[#185e3a] hover:bg-white/50 transition-all"
        >
